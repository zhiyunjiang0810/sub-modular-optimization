...
$n\ge2K$, giving the per-instance form of Theorem~\ref{thm:ceiling}.  Let
...
\subsection{Queries of arbitrary size
  (Theorem~\ref{thm:linear-anysize})}
...
$\nu^{m}>e^{K-1}$.  This proves Theorem~\ref{thm:linear-anysize}, the
