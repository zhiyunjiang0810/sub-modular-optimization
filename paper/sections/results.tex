...
submodular; whether requiring a submodular $\tilde f$ changes $\rho_K$ is
addressed in the remark of Section~\ref{sec:exact} of the appendix.
% F4 investigates this; the sentence will be finalized from F4's output.
\end{remark}
