...
% n >= 4K^5; what remains open is the any-size-query regime (ledger T12),
% the randomized class at finite n, and every budget scale other than
% Q = nK with |S| <= K.  The H-F evidence (PE_1 falls below rho_3 for
