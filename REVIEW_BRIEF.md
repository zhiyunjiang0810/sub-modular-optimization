...
写作日期 2026-09-07。**时效注记（同日晚间，J2 采纳后）**：本文档第 4 节的
Proposition 5（原 4.3 的漏洞）、Theorem 12（hardness 的 Φ 校准与 δ 闭式
[CONJECTURE]）、Remark 13 与 def:etasel 已按外部审查 J2 的修复全部改写，
现状以 paper/ 源码与 REPORT.md 的"J2 采纳日明细"为准；本文档其余背景仍有效。
本文档自足：不需要读过仓库任何其他文件即可开始审查。
